...
namespace BrickInvaders
{
    ...
    namespace Controller
    {
        ...
        public class BasicMapGenerator : MapGenerator
        {
                ...
                for (int i = height - 1; i > 0; i--)
                {
                    ...
                    else
                    {
                        ...
                        if (previous)
                        {
                            ...
                            tempList.Add(new BasicBrick(new Vector2D(x, i)));//J'ajoute une brique
            ...
            {
                return new Ship("Basic ship!");//A compléter je pense
            }

            public void test(int p)//A supprimer quand ça sera OK
            {
